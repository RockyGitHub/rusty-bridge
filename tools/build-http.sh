...
# * dev
# * http-rest
# * bacnet -- experimental -- todo
DATA_SOURCES="http-rest"
...
RUSTFLAGS="-Awarnings" cargo build --no-default-features --features="$FEATURES" --release --target x86_64-pc-windows-gnu --bin rusty-bridge
echo "Flags: $FEATURES"
