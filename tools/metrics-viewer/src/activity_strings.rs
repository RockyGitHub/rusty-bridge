use egui::{containers::*, epaint::Stroke, *};
use log::info;

use crate::data_collection::RustyBridgeData;

pub struct ActivityStrings {
    colors: bool,
}

impl Default for ActivityStrings {
    fn default() -> Self {
        Self { colors: true }
    }
}

//impl super::Display for ActivityStrings {
    ...
    //}
//}
impl super::View for ActivityStrings {
    fn ui(&mut self, ui: &mut Ui, data: &RustyBridgeData) {
        ...
        Frame::canvas(ui.style()).show(ui, |ui| {
            ...
            for &mode in &[2] {
                ...
                let n = 120;
                let speed = 1.5;
                let modifier = data.activity_strings;

                let points: Vec<Pos2> = (0..=n)
                    .map(|i| {
                        let t = i as f64 / (n as f64);
                        let amp = (time * speed * mode).sin() / mode;
                        let y = amp * (t * std::f64::consts::TAU / 2.0 * mode * modifier).sin();
                ...
                shapes.push(epaint::Shape::line(
                    ...
                    if self.colors {
                        ...
                        //Stroke::new_uv(thickness, move |rect, p| {
